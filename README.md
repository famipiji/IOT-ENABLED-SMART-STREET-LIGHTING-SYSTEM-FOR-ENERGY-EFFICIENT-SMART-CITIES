...
Sensing & Control – IoT sensors detect ambient light levels and automatically switch street lights ON/OFF.

Fault Monitoring – When a light malfunctions, the system identifies the faulty node.

Alert System – A Telegram Bot instantly notifies the maintenance team of the issue.

Energy Analysis – Data is collected to compare traditional LEDs with the smart IoT-enabled system.
